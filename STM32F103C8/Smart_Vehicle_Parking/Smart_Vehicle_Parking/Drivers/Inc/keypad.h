...
#define KEYPAD_ROW_PIN0       	   GPIO_PIN0
#define KEYPAD_ROW_PIN1       	   GPIO_PIN1
#define KEYPAD_ROW_PIN2       	   GPIO_PIN2
#define KEYPAD_ROW_PIN3       	   GPIO_PIN3

#define KEYPAD_COL_PORT	          GPIOB
#define KEYPAD_COL_PIN0           GPIO_PIN5
#define KEYPAD_COL_PIN1           GPIO_PIN6
#define KEYPAD_COL_PIN2           GPIO_PIN7
#define KEYPAD_COL_PIN3           GPIO_PIN8
